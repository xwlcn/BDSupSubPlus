...
public class SubPictureBD extends SubPicture {
    ...
    private Map<Integer, ImageObject> imageObjectMap = new HashMap<>();
    private Map<Integer, PCSObject> pcsObjectMap = new HashMap<>();
    ...
    public SubPictureBD(SubPictureBD other) {
        ...
        for (Map.Entry<Integer, ImageObject> io : other.getImageObjectMap().entrySet()) {
            this.imageObjectMap.put(io.getKey(), io.getValue());
        }
        for (Map.Entry<Integer, PCSObject> po : other.getPcsObjectMap().entrySet()) {
            this.pcsObjectMap.put(po.getKey(), po.getValue());
        }
    }
    ...
    ImageObject getImageObject(int index) {
        return imageObjectMap.get(index);
    }
    ...
    ImageObject getImageObject() {
        return imageObjectMap.get(objectID);
    }
    ...
    public Map<Integer, ImageObject> getImageObjectMap() {
        return imageObjectMap;
    }
    ...
    public Map<Integer, PCSObject> getPcsObjectMap() {
        return pcsObjectMap;
    }
